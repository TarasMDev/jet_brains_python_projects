...
from bot.models import friends_db
from bot.services import what_weather, what_temperature, what_conclusion
...
def index(request):
    ...
    if request.method == 'POST':
        ...
        friend_output = f'{selected_friend}, you get {selected_icecream}!'
        city_weather = f'In {city} weather is: {weather}'
